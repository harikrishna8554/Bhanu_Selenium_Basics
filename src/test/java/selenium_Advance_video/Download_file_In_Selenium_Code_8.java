...
public class Download_file_In_Selenium_Code_8 {
	WebDriver driver;
	...
	public void StartBrowser() {
		...
		fprofile.setPreference("browser.download.dir", "C:\\Users\\Harikrishna\\Downloads");
		...
		fprofile.setPreference("browser.helperApps.neverAsk.saveToDisk",
				"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;" // MIME Type of Excel
						...
						+ "text/csv;"
						+ "application/zip;" 
						+ "application/x-gzip;"				//tar file
						+"application/x-msdownload"
						+"application/x-ms-installer"); // MIME Type of exe file
	...
	public void OpenURL() throws InterruptedException {
		...
		File f = new File("C:\\Users\\Harikrishna\\Downloads\\eclipse-inst-win64.exe");
		if (f.exists()) {
			f.delete();
		...
		File file = new File("C:\\Users\\Harikrishna\\Downloads\\eclipse-inst-win64.exe");
		int count = 0;
		...
		File f1 = new File("C:\\Users\\Harikrishna\\Downloads\\eclipse-inst-win64.exe");
		...
		f = new File("C:\\Users\\Harikrishna\\Downloads\\eclipse-inst-win64.exe");
		if (f.exists() && file1>0) {
